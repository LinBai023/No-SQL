from social_graph import fan_comment_template
...
fg = fct.FanGraph(auth=('neo4j','Bailin960203'),
                              host="localhost",
                              port=7687,
                              secure=False)
...
#     c = fg.get_comment("319730d7-6233-47f8-9ec2-d9e0ef8cd51d")
#     print(c)
#     m = "Totally agree!"
#     r = fg.create_sub_comment('al1', "319730d7-6233-47f8-9ec2-d9e0ef8cd51d", m)
#     print(r)
...
#     result = c_result.to_table()
#     print(json.dumps(result, indent=2))
#
# test_get_player_comment()

def test_get_create_team_comment():
    c_result  = fg.get_team_comments(team_id='BOS')
    result = c_result.to_table()
    print(json.dumps(result, indent=2))
test_get_create_team_comment()
